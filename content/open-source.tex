...
\openSourceEntry
  ...
  \openSourceEntry
    ...
    \begin{openSourceItems}
        ...
        \item Custom Hugo Theme called \href{https://github.com/bphenriques/explorer-hugo-theme}{bphenriques/explorer-hugo-theme} featuring:
...
\openSourceEntry
    ...
    {   
    \begin{openSourceDescription}
    In my profile, you will find some code samples across different repositories. The tech-stack and quality will vary depending on what I was working with at the time, experience, and time available:
    \end{openSourceDescription}
    \vspace{8mm}
    \begin{openSourceItems}
