...
\begin{cventries}
  \openSourceEntry
    ...
    Fully declarative NixOS and macOS system configurations (1000+ commits) with modular architecture, reproducible builds using Nix Flakes, encrypted secrets management (sops-nix), and declarative disk partitioning (disko).
    \end{openSourceDescription}
    \vspace{4mm}
    \skilltaglist{\textbf{Nix},Nix Flakes,NixOS,Nix-Darwin,Home-Manager,sops-nix,disko}
    }
...
\openSourceEntry
  ...
  \openSourceEntry
    ...
    \end{openSourceItems}
    \vspace{4mm}
    \skilltaglist{Knowledge Base,Digital Garden,Hugo,org-roam,org-mode,Nix}
    }
