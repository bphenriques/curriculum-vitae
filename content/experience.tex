...
\begin{cventries}
  ...
  \cventry
    ...
    {
      \begin{cvitems}
        \item \textbf{Design, build, and launch Kafka to BigQuery data ingestion pipelines} capable of handling \textbf{~15k events/sec}.
        \item \textbf{Trained team members} on functional programming and Scala (Typelevel Stack).
        \item Designed and built a GDPR Right To Erasure tool to manage PII information in BigQuery.
        \item \textbf{Reduced by ~95\% the cloud costs of a service} by re-designing its data store.
      \end{cvitems}
      \vspace{4mm}
      \skilltaglist{\textbf{Scala},\textbf{Cats},\textbf{Cats Effect},\textbf{FS2},\textbf{Event Stream Processing},Kafka,Terraform,BigQuery,GCP,AWS,\textbf{Docker},\textbf{Kubernetes},Helm,Slack API}
    }
  ...
  \cventry
    ...
    {May. 2019 - May. 2021}
    {
      \begin{cvitems}
        ...
        \item \textbf{Designed, built, and launched \href{https://www.youtube.com/watch?v=W9yJ6gi1ggA}{Outbound Dialer}} product (\textbf{60k phone-calls per day}) - Dialing Engine and Core Telephony components.
  ...
  \cventry
    ...
    {July. 2017 – May. 2019}
    {
      ...
      \end{cvitems}
      \vspace{4mm}
      \skilltaglist{Java,\textbf{Scala},\href{https://www.elastic.co/elastic-stack}{Elastic Stack},RabbitMQ,PostgreSQL,\textbf{Docker},AWS,\textbf{Event Stream Processing},Ansible,\href{https://vega.github.io/vega/}{Vega},\href{https://www.tableau.com/}{Tableau}}
    }
