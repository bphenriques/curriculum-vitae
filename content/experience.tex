...
\begin{cventries}
  ...
  \cventry
    ...
    {June 2021 - Present}
    {
      ...
      \end{cvitems}
      \vspace{4mm}
      \skilltaglist{\textbf{Scala},\textbf{Cats Effect},\textbf{FS2},\textbf{Event Stream Processing},\textbf{Kafka},\textbf{AWS},GCP,Terraform,BigQuery,PostgreSQL,DynamoDB,Kubernetes,GHA}
    }
