...
\begin{cventries}
  ...
  \cventry
    ...
    {
      \begin{cvitems}
        \item \textbf{Leading the technical direction} of Kaluza's GraphQL and Event Streaming API, focusing on operational cost reduction and scalability as the platform expands to new markets.
        \item \textbf{Reduced new market spinnability effort from \textasciitilde{}2 weeks to days} through architecture and process improvements.
