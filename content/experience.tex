...
\begin{cventries}
  ...
  \cventry
    ...
    {
      \begin{cvitems}
        \item \textbf{Design and build} Kafka to BigQuery Data ingestion pipelines to support the analytics platform.
        \item \textbf{Design and build} GDPR Right To Erasure internal tool to manage PII information in BigQuery.
      \end{cvitems}
      \vspace{4mm}
      \skilltaglist{\textbf{Scala},\textbf{Cats},\textbf{Cats Effect},\textbf{FS2},Kafka,Terraform,BigQuery,Google Cloud,AWS,\textbf{Docker}, Helm}
    }
