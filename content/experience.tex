...
\begin{cventries}
  \vspace{-2mm}
  \cventry
    {Backend Software Engineer $\rightarrow$ Tech Lead, API Platform}
    {\href{https://www.kaluza.com/}{Kaluza}}
    {Lisbon, Portugal (Full Remote)}
    {June 2021 - Present}
    {
      \begin{cvitems}
        \item \textbf{Led the API Platform team}, owning Kaluza's GraphQL and Event Streaming APIs.
        ...
        \item \textbf{Mentored team members} in functional Scala, fostering collaboration and shortening knowledge gaps.
        ...
        \item \textbf{Co-led} a cross-team initiative to standardize Kaluza's external interfaces (GraphQL, Events, and Analytics).
  ...
  \cventry
    ...
    {May 2019 - May 2021}
    {
      \begin{cvitems}
        ...
        \item \textbf{Mentored team members} by conducting Spring Boot workshops.
      \end{cvitems}
      \vspace{4mm}
