...
\begin{cventries}
  ...
  \cventry
    ...
    {
      \begin{cvitems}
        \item \textbf{Leading the technical direction} of Kaluza's GraphQL and Event Streaming API, authoring technical designs and aligning with engineering stakeholders on cost reduction and scalability.
        \item \textbf{Reduced new market spinnability effort from \textasciitilde{}2 weeks to days}, enabling the team to expand across 3+ markets in the short-term.
        \item \textbf{Improved internal developer experience} by enabling local server execution and automating API registration onto the documentation site through cross-team collaboration.
      \end{cvitems}
      \vspace{4mm}
      \skilltaglist{\textbf{Scala},\textbf{Typelevel},GraphQL,\textbf{Event Stream Processing},\textbf{Kafka},\textbf{AWS},Terraform,Kubernetes}
    }
  ...
  \cventry
    ...
    {June 2021 - September 2024}
    {
      \begin{cvitems}
        ...
        \item \textbf{Participated in on-call rotation} supporting Kaluza's GraphQL and Event Streaming services.
      \end{cvitems}
      \vspace{4mm}
